...
MultitenancyRepository.prototype.find = function (query) {
    return this.db().then(function (db) {
        return q.ninvoke(db.collection("tenants"), "find", query).then(function (res) {
            return res;
        });
    });
};

MultitenancyRepository.prototype.update = function (query, update) {
    return this.db().then(function (db) {
        return q.ninvoke(db.collection("tenants"), "updateMany", query, update).then(function (res) {
            return res;
        });
    });
};
